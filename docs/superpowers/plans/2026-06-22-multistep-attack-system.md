...
| Gate | Required |
|---|---|
| Real-model score | nonzero on both target models for small N |
| Runtime | score density acceptable vs C1 |
| Trace match | expected multi-step path appears, not accidental fallback |
